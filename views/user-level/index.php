...
/* @var $searchModel core\models\search\UserLevelSearch */
...
<div class="user-level-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model, $index, $widget) {
                    return Html::checkbox('is_super_admin[]', $model->is_super_admin, ['value' => $index, 'disabled' => 'disabled']);
                },
            ],
            'keterangan:ntext',
        ...
        'rowOptions' => function ($model, $key, $index, $grid) {
            return ['id' => $model['id'], 'class' => 'row-grid-view-user-level', 'style' => 'cursor: pointer;'];
        },
        'pager' => [
...
$jscript = ''
    ...
    $("div.container.body").on("click", function(event) {
        ...
        if ($(event.target).parent(".row-grid-view-user-level").length > 0) {
    ...
    $(".row-grid-view-user-level").popover({
        trigger: "click",
        placement: "top",
        container: ".row-grid-view-user-level",
        html: true,
        selector: "td",
        content: function () {
    ...
    $(".row-grid-view-user-level").on("shown.bs.popover", function(event) {
